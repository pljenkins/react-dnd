...
export default function DragLayer(collect, options = {}) {
  ...
  invariant(
    ...
    'Instead, received %s. ' +
    'Read more: http://pljenkins.github.io/react-dnd/docs-drag-layer.html',
    collect
  );
  invariant(
    ...
    return class DragLayerContainer extends Component {
      ...
      constructor(props, context) {
        ...
        invariant(
          ...
          'Read more: http://pljenkins.github.io/react-dnd/docs-troubleshooting.html#could-not-find-the-drag-and-drop-manager-in-the-context',
          displayName,
          displayName
        );
